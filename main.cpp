...
//int는 메모리에 4바이트만큼의 크기를 할당해 정수형 데이터만을 담는 것...일단 알고있는건 이정도
//앓
...
int main() {
	...
	int color = 0;	// 프로그래밍은 숫자를 일단 넣어놓고 의미를 나중에 부여하는 것이다. 
					// 숫자를 넣었지만 저것은 숫자가 아니라고 생각하는 것이 중요하다. 로우 레벨 프로그래밍의 기본이다.
	int B = (int)A;
	cout << B;
